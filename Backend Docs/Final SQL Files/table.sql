...
ALTER TABLE STUDENT MODIFY (STD_ID NOT NULL)
ALTER TABLE EVENT MODIFY (EVENT_ID NOT NULL)
ALTER TABLE BOOKS MODIFY (ISBN_NO NOT NULL)
ALTER TABLE PARTICIPANT MODIFY (P_ID NOT NULL)
